...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplays (\
        songplay_id int, start_time numeric, user_id int, level int,\
        song_id varchar, artist_id varchar, session_id int, location varchar,\
        user_agent varchar);"

user_table_create = "CREATE TABLE IF NOT EXISTS users (\
        user_id int, first_name varchar, last_name varchar, gender bytea,\
        level bytea);"

song_table_create = "CREATE TABLE IF NOT EXISTS songs (\
        song_id varchar, title varchar, artist_id varchar, year int,\
        duration numeric);"

artist_table_create = "CREATE TABLE IF NOT EXISTS artists (\
        artist_id varchar, name varchar, location varchar, lattitude numeric,\
        longitude numeric);"

time_table_create = "CREATE TABLE IF NOT EXISTS users (\
        start_time date, hour int, day int,week int, month int, year int,\
        weekday boolean);"
...
time_table_insert = "INSERT INTO artists (start_time, hour, day, week, month,\
                year, weekday) VALUES (%s, %s, %s, %s, %s);"

# FIND SONGS

song_select = "SELECT songs.song_id FROM songs\
